<<<<<<< HEAD
=======
<<<<<<< HEAD:src/TransferToUML/impl/Field.java
...
public class Variable implements IVariable, ITraverser {
	private int access;
	private String name;
	private String description;
	private String signature;
	...
	public Variable(int access, String name, String desc, String signature, Object value) {
		this.access = access;
		this.name = name;
		this.description = desc;
		this.signature = signature;
...
<<<<<<< HEAD
=======
>>>>>>> origin/master:src/TransferToUML/impl/Variable.java
>>>>>>> master
